...
const table = document.querySelector(".race");
for (let i = 0; i < ab.length; i++) {
  // Many ways to solve this problem ------------
  // const p = document.getElementById("para");
  
  const row = document.createElement("tr");
   row.innerHTML = `<td>${ab[i].name}</td> <td>${ab[i].cuisine}</td>`

  // p.innerText = ab[i].name +" " + ab[i].cuisine;
  // p.textContent = `Name: ${ab[i].name}, Cuisine: ${ab[i].cuisine}`;
  // p.innerHTML = `Name: ${ab[i].name}, Cuisine: ${ab[i].cuisine}`;
